    ...
    workstreams: [
      {
        ...
        memberName: "Mina",
        initials: "MN",
        title: "Harden session rotation",
        outcome: "Rotate browser sessions after a device privilege change.",
        presence: "online",
        fidelity: "mcp",
        updatedLabel: "Now",
        pathCount: 7,
    ...
    findings: [
      {
        ...
        state: "open",
        title: "Session contract is changing in two workstreams",
        reason: "Both active workstreams report the same session schema and dashboard boundary.",
        workstreamIds: ["wst_atlas_session", "wst_atlas_manifest"],
        evidence: [
