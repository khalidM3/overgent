...
if (process.argv.includes("--live")) {
  const iterations = Number.parseInt(process.env.OVERGENT_HARDENING_ITERATIONS ?? "5", 10);
  if (!Number.isSafeInteger(iterations) || iterations < 1 || iterations > 100) {
    throw new Error("OVERGENT_HARDENING_ITERATIONS must be between 1 and 100");
  }
