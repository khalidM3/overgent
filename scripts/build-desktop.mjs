...
const app = path.join(output, "Stickguy.app");
const executable = path.join(app, "Contents", "MacOS", "stickguy-desktop");
...
const build = spawnSync("go", ["build", "-tags", "production", "-trimpath", "-ldflags", "-w -s", "-o", executable, "."], {
  cwd: desktop,
  env: {
    ...process.env,
...
<plist version="1.0"><dict>
  <key>CFBundleDisplayName</key><string>Stickguy</string>
  <key>CFBundleExecutable</key><string>stickguy-desktop</string>
  <key>CFBundleIdentifier</key><string>dev.stickguy.app</string>
  <key>CFBundleInfoDictionaryVersion</key><string>6.0</string>
  <key>CFBundleName</key><string>Stickguy</string>
