...
10. [`prebuild-validation.md`](prebuild-validation.md) — executable architecture/adapter assumptions to prove first.
11. [`implementation-plan.md`](implementation-plan.md) — continuous order/exit gates.
